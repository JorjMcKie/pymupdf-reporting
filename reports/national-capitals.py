import fitz
from Reports import SimpleBlock, FrontMatterReport, LongTable


def fetch_rows():
    csv_data = """country;capital;population;percent;year
...
South Georgia and the South Sandwich Islands (UK);King Edward Point;22;73.3%;2018"""
    ...
    data = [i.split(";") for i in csv_data.splitlines()]
    return data


HEADER = """<h1 style="text-align:center">World Capital Cities</h1>
...
header = SimpleBlock(html=HEADER, report=report, css=CSS)
table = LongTable(
    html=HTML,
    report=report,
    ...
    top_row="top-row",
    top_row_bg="#ffff00",
    alternating_bg=("#eee", "#fff"),
    css=CSS,
)
report.page0 = [header, table]
report.pages = [table]
report.run("capital-cities.pdf")
